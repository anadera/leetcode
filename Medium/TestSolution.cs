...
internal class TestSolution
{
    ...
    [TestCase("au",2)]
    [TestCase("dvdf",3)]
    public void TestLengthOfLongestSubstring(string s, int r)
    {
        Assert.AreEqual(r, Solution.LengthOfLongestSubstring(s));
    }

    [TestCase("babad", "bab")]
    [TestCase("cbbc","cbbc")]
    [TestCase("dddfgfgf","fgfgf")]
    [TestCase("avc", "a")]
    [TestCase("aaaa","aaaa")]
    [TestCase("bananas", "anana")]
    [TestCase("tattarrattat","tattarrattat")]
    public void TestLongestPalindrome(string s, string result)
    {
        var r = Solution.LongestPalindrome(s);
